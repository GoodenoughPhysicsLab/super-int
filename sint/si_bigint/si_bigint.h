...
int si_bigint_self_sub(si_bigint const *, si_bigint const *);
int si_bigint_self_sub_num(si_bigint const *, intmax_t const);
int si_bigint_self_mul(si_bigint const *, si_bigint const *);
int si_bigint_self_mul_num(si_bigint const *, intmax_t const);
int si_bigint_self_div(si_bigint const *, si_bigint const *);
